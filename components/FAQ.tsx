...
export default function FAQSection() {
  ...
  return (
    <section id="faq" className="relative py-24 md:py-32 px-6 md:px-8 bg-white overflow-hidden">
      ...
      <div className="absolute top-10 left-4 md:left-10 text-3xl md:text-4xl opacity-[0.06] pointer-events-none z-0">❓</div>
      ...
      <div className="absolute bottom-10 right-1/3 text-2xl md:text-3xl opacity-[0.06] pointer-events-none z-0">💡</div>
