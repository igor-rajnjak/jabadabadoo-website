...
export default function Contact() {
  return (
    <section id="kontakt" className="relative py-24 md:py-32 px-6 md:px-8 bg-gradient-to-b from-white to-bg overflow-hidden">
      ...
      <div className="absolute top-1/3 right-4 md:right-10 text-2xl md:text-3xl opacity-[0.06] pointer-events-none z-0">✉️</div>
          ...
          <div>
            ...
            <div className="space-y-6 md:space-y-8 mb-10 md:mb-12">
              <div className="bg-white p-8 md:p-10 rounded-3xl border-4 border-secondary shadow-lg">
                <p className="font-bold text-lg md:text-xl mb-4">📞 Telefon</p>
                <a
                  href={`tel:${CONTACT.phoneFormatted}`}
                  onClick={() => trackPhoneCall(CONTACT.phone, "Contact Section")}
                  className="text-primary text-xl md:text-2xl font-bold hover:underline block mb-6"
                >
                  {CONTACT.phone}
                </a>
                
                {/* WhatsApp Button - Prominent, Touch-friendly */}
                <a
                ...
                >
                  <svg className="w-6 h-6 md:w-7 md:h-7 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span>Pošaljite poruku na WhatsApp</span>
                </a>
                
                <p className="text-sm md:text-base text-text/60 mt-4 text-center">
                  Pozovite nas ili pošaljite poruku na WhatsApp
                </p>
              </div>
