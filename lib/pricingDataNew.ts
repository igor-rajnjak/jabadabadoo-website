...
export const PACKAGES_DATA_NEW: Package[] = [
  {
    ...
    standardFeatures: [
      ...
      { text: "🎟️ Poklon kartica za slavljenika 2h (vrednost: 760 RSD)", tooltip: "Poklon vaučer za slavljenika - 2 sata besplatnog korišćenja igraonice u narednih 30 dana." },
